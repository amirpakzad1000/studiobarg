...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \studiobarg\User\Models\User::class,
    ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\studiobarg\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\laragon\\www\\studiobarg\\public\\storage','logging.default',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','ide-helper.filename',
