...
;(function (window, document, $, undefined) {
    ...
    var defaults = {
        ...
        // Do not let auth to focus on element outside modal content
        trapFocus : true,
        ...
        */
        ...
        // Use options below to customize taken action when auth clicks or double clicks on the fancyBox area,
    ...
    $.extend(FancyBox.prototype, {
        ...
        addEvents : function() {
            ...
            // Trap keyboard focus inside of the modal, so the auth does not accidentally tab outside of the modal
        ...
        setContent : function ( slide, content ) {
            ...
            if ( isQuery( content ) && content.parent().length ) {
                ...
                // If auth is navigating gallery fast, then the content might be already inside fancyBox
                // =====================================================================================
        ...
        afterLoad : function( slide ) {
            ...
            if ( slide.opts.protect && slide.$content && !slide.hasError ) {
                ...
                // This makes a bit harder for auth to select image
                if ( slide.type === 'image' ) {
        ...
        // auth navigates gallery and transition should start
        // ============================================================
...
;(function (window, document, $) {
	...
	Guestures.prototype.onTap = function(e) {
		...
		if ( self.tapped ) {
			...
			// Single tap will be processed if auth has not clicked second time within 300ms
...
;(function (document, $) {
	...
	// Collection of methods supported by auth browser
	var fn = (function () {
...
;(function (document, window, $) {
    ...
    $(function() {
		...
		// Check if auth has disabled this module
